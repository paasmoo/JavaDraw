...
public class JFontChooser extends JComponent {
    ...
    protected JPanel samplePanel = null;
    ...
    /**
     * Constructs a <code>JFontChooser</code> object using the given font
     * size array.
     *
    ...
    protected class ListSearchTextFieldDocumentHandler implements DocumentListener {
        ...
        private void update(DocumentEvent event) {
            ...
            if (newValue.length() > 0) {
                ...
                String matchedName =
                        targetList.getModel().getElementAt(index).toString();
    ...
    protected class DialogOKAction extends AbstractAction {
        ...
        protected DialogOKAction(JDialog dialog) {
            this.dialog = dialog;
            putValue(Action.DEFAULT, Config.bundle.getString("Ok"));
            putValue(Action.ACTION_COMMAND_KEY, Config.bundle.getString("Ok"));
            putValue(Action.NAME, (Config.bundle.getString("Ok")));
        }
    ...
    protected class DialogCancelAction extends AbstractAction {
        ...
        protected DialogCancelAction(JDialog dialog) {
            this.dialog = dialog;
            putValue(Action.DEFAULT, Config.bundle.getString("Cancel"));
            putValue(Action.ACTION_COMMAND_KEY, Config.bundle.getString("Cancel"));
            putValue(Action.NAME, (Config.bundle.getString("Cancel")));
        }
    ...
    protected JPanel getFontFamilyPanel() {
        if (fontNamePanel == null) {
            ...
            fontNamePanel.setBorder(BorderFactory.createEmptyBorder(5, 5, 5,
                    5));
            ...
            JLabel label = new JLabel((Config.bundle.getString("FontFamily")));
    ...
    protected JPanel getFontStylePanel() {
        if (fontStylePanel == null) {
            ...
            fontStylePanel.setBorder(BorderFactory.createEmptyBorder(5, 5, 5,
                    5));
            ...
            JLabel label = new JLabel((Config.bundle.getString("FontStyle")));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    protected JPanel getFontSizePanel() {
        if (fontSizePanel == null) {
            ...
            fontSizePanel.setPreferredSize(new Dimension(100, 130));
            fontSizePanel.setBorder(BorderFactory.createEmptyBorder(5, 5, 5,
                    5));
            ...
            JLabel label = new JLabel((Config.bundle.getString("FontSize")));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
